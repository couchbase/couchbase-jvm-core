...
public class RedactableArgumentTest {
    ...
    public static void saveOrigLevel() {
        origLevel = CouchbaseLoggerFactory.getRedactionLevel();
    }

    @AfterClass
    public static void restoreOrigLevel() {
        CouchbaseLoggerFactory.setRedactionLevel(origLevel);
    }

    @Test
    public void shouldNotRedactLogsWhenDisabled() {
        CouchbaseLoggerFactory.setRedactionLevel(RedactionLevel.NONE);
    ...
    public void shouldOnlyRedactUserOnPartial() {
        CouchbaseLoggerFactory.setRedactionLevel(RedactionLevel.PARTIAL);
